...
describe('getPalindromes', () => {
  ...
  it('identifies palindromes', () => {
    ...
    expect(getPalindromes(['racecar', 'racecar'])).to.eql([
      'racecar',
      'racecar'
    ]);
  });
  it('ignores non-palindromes', () => {
    expect(getPalindromes(['racecar', 'kayak', 'tacocat'])).to.eql([
      'racecar',
      'kayak',
      'tacocat'
    ]);
...
describe('getWilliams', () => {
  ...
  it('ignores Williams found in first names', () => {
    expect(getWilliams(['William Jones', 'Harry Williams'])).to.eql([
      'Harry Williams'
    ]);
  });
  it('ignores Williams found in extended last names', () => {
    expect(getWilliams(['John Williams', 'Chris Williamson'])).to.eql([
      'John Williams'
    ]);
  });
});
